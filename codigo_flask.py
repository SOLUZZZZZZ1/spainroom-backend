...
async def answer_cr(request: Request):
    ...
    welcome = _env("CR_WELCOME", "")  # p.ej.: "Bienvenido a SpainRoom."
    attrs = [
...
KNOWLEDGE: Dict[str, Dict[str, Any]] = {
    ...
    "propietarios": {
        # más explícito para no colisionar con 'propietario'
...
def _match_topic(tl: str, step: str):
    # Nunca activar conocimiento durante el flujo principal
    if step in ("role", "city", "zone", "name", "phone"):
        return None
    # Ni si el texto contiene rol explícito
